<x-layout bodyClass="g-sidenav-show bg-gray-200">
    ...
    <x-navbars.sidebar activePage="puesto-create"></x-navbars.sidebar>
    <div class="main-content position-relative bg-gray-100 max-height-vh-100 h-100">
        <!-- Navbar -->
        <x-navbars.navs.auth titlePage='Crear nuevo perfil'></x-navbars.navs.auth>
        <!-- End Navbar -->
                        ...
                        <form method='POST' action="{{ route('puesto.store') }}">
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="text" id="tipo_empleo" name="tipo_empleo"
                                        class="form-control border border-2 p-2">
